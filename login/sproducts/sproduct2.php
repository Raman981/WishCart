      ...
      <section id="header">
	    ...
	    <section id="prodetails" class="section-p1">
		   <div class="single-pro-image">
		       <img src="../images/black-white.jpg" width="100%" id="main-img"alt="">
		       
		   </div>
		   <div class="single-pro-details">
                <h1>Casual Reglar fit shirt </h1> <!-- Main page title -->
                <h2>Product Details</h2> <!-- Section title -->
                    <p>
                        Lymio Men's Solid Regular Fit Shirt
                    </p>
                    <p><strong>Price:</strong> $55.00</p> <!-- Use <p> for price -->
				...
				<div class="pro-details-col">
					...
					<p><strong>Material Composition :  </strong> polyester<br>
					<strong>Pattern :</strong> solid<br>
					<strong>Fit Type : </strong> Regular Fit<br>
					<strong>Sleeve Type :  </strong> Half Sleeve<br>
					<strong>Collar Style :  </strong> collared neck<br>
					<strong>Length : </strong> Standard Length<br>
					<strong>Country Of Origin : </strong> India</p>
				</div>
				<div class="additional-info">
	                <h3>About this item</h3>
					    <p>&bull;Casual Shirt for Men|| Shirt for Men|| 
						Men Stylish Shirt</p>
						<p>&bull;Style:Casual</p>
						<p>&bull;Neckline:Collar</p>
						<p>&bull;Sleeve Length:Short Sleeve</p>
						<p>&bull;Reguler Fit</p>
				</div>   
		    </div>
		</section>
		...
		<section id="prodes" class="section-p1">
		    <div class="pro-description">
				    ...
				    <p>Made with 100% Poleyster Fabric, Fashion Casual shirtare Gentle on your skin 
					while providing absolute comfort. Feature like Easydry. Keep you fresh and dry
					Throughout the day .
					Showing off your classy style even an ordinary day surely possibke when you have 
					thsi casual solid men's shirt</p>
			</div>
		</section>
